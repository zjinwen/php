...
<head>
    ...
    <script src="../undercover/js/jquery-1.7.2.min.js"></script>
    <script src="../undercover/js/jquery.spinner.js"></script>
...
<div class="container">
    ...
    <div class="jumbotron">
        <p class="lead">
            ...
            try {
                ...
                <div class="checkbox">
                    ...
                    <input type="text" class="spinner" name="<?php echo $row['name'] ?>" value="0"/>
                </div>
        ...
        <p><input type="submit" class="btn btn-lg btn-success" href="room.php" role="button" value="创建" /></p>
