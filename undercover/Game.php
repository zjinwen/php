...
require_once 'role/PlayerRole.php';
...
class Game
{
    ...
    const GAME_STATUS_FREE=1;
    const GAME_STATUS_FULL=2;

    const STATUS_NIGHT =5;
    const STATUS_DAY =7;
    const STATUS_DAY_SPEAK_ORDER =8;
    const STATUS_DAY_POLICE =9;
    const STATUS_DAY_POLICE_SPEAK =10;

    const STATUS_DAY_POLICE_VOTE =11;

    const STATUS_DAY_SPEAK=12;
    const STATUS_DAY_VOTE=13;
    const STATUS_WIN_WERWOLF =100;
    const STATUS_WIN_VILLAGER =101;

    public  $chat;
    public  $globalMs=[];
    public  $globalMsLast=null;

    public  $status=Game::GAME_STATUS_FREE;
    ...
    function __construct() {
        ...
        $obj->lifeUse=false;
        $obj->curUse=null;
        $this->lasttWitchExt=$obj;
        $this->globalMs=[];
        $this->privateMs=[];
        $this->hasPolice=false;
        $this->voteTimeStart=0;
        $this->voteTimeEnd=0;
        $this->votes=[];
    }

    public function isFull(){
       return  $this->status==Game::GAME_STATUS_FULL;
    }
